...
export const TeamDetails = () => {
  ...
  const qbs = team.players
    ? team.players.filter((player) => player.positionId === 1)
    : [];
  const rbs = team.players
    ? team.players.filter((player) => player.positionId === 2)
    : [];
  const wrs = team.players
    ? team.players.filter((player) => player.positionId === 3)
    : [];
  const tes = team.players
    ? team.players.filter((player) => player.positionId === 4)
    : [];
